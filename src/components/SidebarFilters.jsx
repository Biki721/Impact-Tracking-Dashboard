...
function SidebarFilters({ filters, onChange, kpis, onGenerateSummary }) {
  ...
  return (
    <aside className="hidden lg:flex lg:w-64 xl:w-72 flex-col border-r border-slate-800 bg-slate-950/60 px-3 py-3 gap-3">
      <div>
        <h2 className="text-xs font-semibold text-slate-300 mb-1.5">Quick Stats</h2>
      ...
      <div className="mt-1">
        <button
          ...
          className="w-full inline-flex items-center justify-center gap-1.5 rounded-lg bg-emerald-600 px-2.5 py-1.5 text-[11px] font-medium text-emerald-50 shadow-sm hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-1 focus:ring-offset-slate-950"
        >
      ...
      <div className="mt-1 space-y-2 text-[11px]">
        ...
        <div>
          <h3 className="font-semibold text-slate-300 mb-1">Tech tag</h3>
          <input
            value={filters.tech}
        ...
        <div className="grid grid-cols-2 gap-2">
          <div>
            <h3 className="font-semibold text-slate-300 mb-1">From</h3>
            <input
              type="date"
          ...
          <div>
            <h3 className="font-semibold text-slate-300 mb-1">To</h3>
            <input
              type="date"
        ...
        <div className="grid grid-cols-2 gap-2">
          <div>
            <h3 className="font-semibold text-slate-300 mb-1">Min hours/mo</h3>
            <input
              type="number"
              min={0}
          ...
          <div>
            <h3 className="font-semibold text-slate-300 mb-1">Min users</h3>
            <input
              type="number"
              min={0}
        ...
        <div>
          <h3 className="font-semibold text-slate-300 mb-1">Min steps removed</h3>
          <input
            type="number"
            min={0}
